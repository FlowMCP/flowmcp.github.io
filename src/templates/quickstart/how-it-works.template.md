...
Every FlowMCP v{{spec.currentVersion}} schema uses the **two-export pattern**:
...
:::note
For the full specification including all validation rules, parameter formats, and security details, see the [Specification v{{spec.currentVersion}}](/specification/overview/).
:::
