...
<CopyMarkdown slug="quickstart/installation" lang="en" />
...
{{stats.count_schemas}}+ production-ready schemas ship with the CLI, covering providers like Etherscan, Moralis, DeFi Llama, Dune Analytics, OpenWeather, GitHub, and many more. Each schema is validated, tested, and follows the v4.1.0 specification.
