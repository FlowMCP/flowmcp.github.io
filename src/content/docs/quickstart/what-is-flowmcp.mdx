...
:::note[Installation]
System requirements and setup instructions. See [Installation](/quickstart/installation/).
:::

:::note[CLI Reference]
Complete command reference for search, add, call, validate, and test. See [CLI Reference](/guides/cli-reference/).
:::

:::note[Schema Creation]
Write your own schemas from scratch. See [Schema Creation](/guides/schema-creation/).
:::

:::note[Specification]
Full v4.0.0 specification with all primitives and validation rules. See [Specification](/specification/overview/).
:::
