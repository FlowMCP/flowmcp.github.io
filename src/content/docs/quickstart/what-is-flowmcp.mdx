...
FlowMCP v4.1.0 supports four primitives in a single schema file:
...
:::note[CLI Reference]
Complete command reference for search, add, call, validate, and test. See [CLI Usage](/reference/cli/).
:::
...
:::note[Specification]
Full v4.1.0 specification with all primitives and validation rules. See [Specification](/specification/overview/).
:::
