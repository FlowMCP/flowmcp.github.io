...
See [Security Model](/docs/specification/security/) for the complete list of forbidden patterns and error codes.
...
See [Tests](/docs/specification/route-tests/) for the complete test specification.
...
See [Groups & Skills](/docs/specification/groups-prompts/) for skill format details.
