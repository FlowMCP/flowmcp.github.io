...
:::note
This page covers output schemas from the [formal specification](https://github.com/FlowMCP/flowmcp-spec). See [Route Tests](/docs/specification/route-tests/) for how output schemas are generated from captured responses.
:::
