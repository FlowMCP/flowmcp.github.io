...
|----------|-------------|
| [Schema Format](/docs/specification/schema-format/) | File structure, main/handlers split, tool definitions, naming conventions |
| [Parameters](/docs/specification/parameters/) | Position block, Z block validation, shared list interpolation, API key injection |
| [Shared Lists](/docs/specification/shared-lists/) | List format, versioning, field definitions, filtering, resolution lifecycle |
| [Output Schema](/docs/specification/output-schema/) | Response type declarations, field mapping, validation rules |
| [Security Model](/docs/specification/security/) | Zero-import policy, library allowlist, static scan, dependency injection |
| [Resources](/docs/specification/resources/) | SQLite-based read-only data, query definitions, SQL security |
| [Skills](/docs/specification/skills/) | AI agent instructions, placeholder system, versioning |
| [Groups & Skills](/docs/specification/groups-prompts/) | Cherry-pick groups, integrity hashes, skill workflows |
| [Tests](/docs/specification/route-tests/) | Test format, response capture lifecycle, output schema generation |
| [Preload](/docs/specification/preload/) | Cache configuration, TTL guidelines, runtime behavior |
| [Validation Rules](/docs/specification/validation-rules/) | Validation rules across categories with severity levels |
| [Migration Guide](/docs/specification/migration/) | Step-by-step migration guides for v1-to-v2 and v2-to-v3 |
