...
| **v4.1+** | Data-format add-ons — external toolkits (`gtfs-sqlite-toolkit`, `geojson-sqlite-toolkit`, `csv-tsv-sqlite-toolkit`) convert files into sealed SQLite resources |
