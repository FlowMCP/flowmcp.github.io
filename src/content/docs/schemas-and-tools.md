...
That's what [FlowMCP](https://docs.flowmcp.org) does — an open-source framework that loads schemas, validates the structure, runs the tests, and exposes the tools via the **Model Context Protocol (MCP)**. Over 100 AI clients already support MCP — from Claude to ChatGPT to Cursor.
...
The community can contribute schemas through a [5-stage pipeline](/community/) with automatic validation, AI review, and human approval. The principle: **"Validated once, for all."** What has been carefully reviewed once is available to everyone afterward.

## Create Your Own Schemas

Schemas follow the FlowMCP Specification v3.0.0:

- **Documentation:** [docs.flowmcp.org](https://docs.flowmcp.org)
- **Specification:** [FlowMCP Spec v3.0.0](https://github.com/FlowMCP/flowmcp-spec)
- **How to contribute:** [Community Hub →](/community/)
