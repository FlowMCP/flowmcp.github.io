...
- **Tool references** — the agent selects tools from various [provider schemas](/concepts/schemas-and-tools/). It doesn't take all of them, only the relevant ones.
...
Which clients support what: [Clients and Compatibility →](/concepts/clients/)
