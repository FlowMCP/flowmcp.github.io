...
:::note
This page focuses on practical tool creation. See [Schema Format](/specification/schema-format/) for the full specification and [Parameters](/specification/parameters/) for parameter details.
:::
...
| `sharedLists` | `object[]` | Shared list references for dynamic enum values. See [Shared Lists](/specification/shared-lists/). |
