...
Schemas are organised under provider namespaces in the public schema repository. Inventory snapshot (Stand 2026-05-24):

- 468+ production schemas across 13 categories (Blockchain EVM, Blockchain Solana, DeFi, Crypto Data, Government DE/EU, Weather & Geo, Web3 Social, News & Media, Dev Tools, NFT & Identity, Analytics)
- 728+ individual tools exposed via these schemas
