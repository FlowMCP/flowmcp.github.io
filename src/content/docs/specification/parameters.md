...
:::note
This page covers parameters from the [formal specification](https://github.com/FlowMCP/flowmcp-spec). See [Shared Lists](/specification/shared-lists/) for list interpolation details.
:::
