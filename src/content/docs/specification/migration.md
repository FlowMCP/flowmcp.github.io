...
The current FlowMCP spec is **v4.0.0**. New schemas should use the v4 format directly — see [Schema Format](/specification/schema-format/). This page documents the historical upgrade paths for schemas authored against earlier specs.
...
4. **Add resources (optional)** — If your schema benefits from local data lookups, see [Resources](/specification/resources/).

5. **Add skills (optional)** — If your schema benefits from AI agent workflows, see [Skills](/specification/skills/).
...
4. **Add output schemas (optional)** — New in v2.0.0. See [Output Schema](/specification/output-schema/).
