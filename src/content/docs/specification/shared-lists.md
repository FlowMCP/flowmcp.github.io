...
:::note
This page covers shared lists from the [formal specification](https://github.com/FlowMCP/flowmcp-spec). See [Parameters](/specification/parameters/) for how schemas use shared list interpolation.
:::
