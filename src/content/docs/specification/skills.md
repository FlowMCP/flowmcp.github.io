...
Schema-level skills (this page) are part of the schema and travel with it. Group-level skills (see [Groups & Skills](/specification/groups-prompts/)) are project-local and can reference tools from any schema in the group.
