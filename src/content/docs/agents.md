...
- **Tool references** — the agent selects tools from various [provider schemas](/schemas-and-tools/). It doesn't take all of them, only the relevant ones.
...
Which clients support what: [Clients and Compatibility →](/mcp-clients/)
...
- **Agent manifests and configuration:** [docs.flowmcp.org](https://docs.flowmcp.org)
