...
<Aside type="tip" title="Hackathon-Teilnehmende">
    Du baust im Hackathon? Kopiere das Hackathon-Kit-Skill-Snippet und fuege es in den Kontext deines KI-Assistenten ein — es gibt nichts zu installieren und keinen Befehl zum erneuten Ausfuehren. Es fuehrt deinen Agenten in unter 60 Sekunden durch das Scaffolding eines MCP-Servers.
