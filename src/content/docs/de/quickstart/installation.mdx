...
Schemas decken Provider wie CoinGecko, Etherscan, Moralis, DeFi Llama, Dune Analytics, OpenWeather, GitHub und viele mehr ab. Jedes Schema ist validiert, getestet und folgt der v4.1.0-Spezifikation.
