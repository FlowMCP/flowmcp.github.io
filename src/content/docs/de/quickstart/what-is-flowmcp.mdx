...
:::note[CLI-Referenz]
Vollstaendige Befehlsreferenz fuer search, add, call, validate und test. Siehe [CLI-Referenz](/de/guides/cli-reference/).
:::
...
:::note[Spezifikation]
Vollstaendige v4.0.0-Spezifikation mit allen Primitiven und Validierungsregeln. Siehe [Spezifikation](/de/specification/overview/).
:::
