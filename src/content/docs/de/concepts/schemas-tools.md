...
:::note
Diese Seite konzentriert sich auf die praktische Tool-Erstellung. Siehe [Schema-Format](/de/specification/schema-format/) fuer die vollstaendige Spezifikation und [Parameter](/de/specification/parameters/) fuer Parameterdetails.
:::
...
| `sharedLists` | `object[]` | Shared-List-Referenzen fuer dynamische Enum-Werte. Siehe [Shared Lists](/de/specification/shared-lists/). |
