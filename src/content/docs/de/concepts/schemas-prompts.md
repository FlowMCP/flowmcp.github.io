...
Prompts sind erklaerende Texte, die einem Namespace zugeordnet sind. Sie bringen KI-Agenten bei, wie die Tools eines Providers zusammenarbeiten -- Paginierungs-Muster, Fehlercodes, Rate Limits, Endpoint-Kombination. Prompts **erklaeren**, sie **instruieren** nicht (dafuer sind [Skills](/de/concepts/schemas-skills/) da).
...
Siehe [Prompt-Architektur](/de/specification/prompt-architecture/) fuer das vollstaendige Zwei-Stufen-System (Provider-Prompts vs Agent-Prompts).
