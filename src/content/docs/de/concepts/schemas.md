...
Schemas sind in Provider-Namespaces im oeffentlichen Schema-Repository organisiert. Inventar-Stand (2026-05-24):

- 468+ Production-Schemas in 13 Kategorien (Blockchain EVM, Blockchain Solana, DeFi, Crypto Data, Government DE/EU, Weather & Geo, Web3 Social, News & Media, Dev Tools, NFT & Identity, Analytics)
- 728+ einzelne Tools, die ueber diese Schemas bereitgestellt werden
