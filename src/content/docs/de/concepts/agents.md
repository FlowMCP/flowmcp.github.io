...
- **Tool-Referenzen** — der Agent waehlt sich aus verschiedenen [Provider-Schemas](/de/concepts/schemas-and-tools/) die Tools aus, die er braucht. Er nimmt nicht alle, sondern nur die relevanten.
...
Welche Clients was unterstuetzen: [Clients und Kompatibilitaet →](/de/concepts/clients/)
