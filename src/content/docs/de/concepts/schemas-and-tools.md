...
Das uebernimmt [FlowMCP](/de/quickstart/what-is-flowmcp/) — ein Open-Source-Framework, das Schemas laedt, die Struktur validiert, die Tests ausfuehrt und die Tools ueber das **Model Context Protocol (MCP)** bereitstellt. Ueber 100 KI-Clients unterstuetzen MCP bereits — von Claude ueber ChatGPT bis Cursor.
...
Schemas folgen der FlowMCP Spezifikation v4.1.0:

- **Dokumentation:** [Schema Uebersicht](/de/concepts/schemas-overview/)
- **Spezifikation:** [FlowMCP Spec v4.1.0](https://github.com/FlowMCP/flowmcp-spec)
