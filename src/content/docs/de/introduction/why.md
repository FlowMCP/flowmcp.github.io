...
Unsere Schemas machen diese Kombination moeglich — ohne dass der Nutzer wissen muss, woher die Daten kommen. Konkrete Beispiele: [Use Cases →](/de/introduction/use-cases/)
...
Das gilt auch fuer den Betrieb: Wer moechte, kann unsere Schemas auf einem lokalen Server betreiben — komplett unabhaengig von Cloud-Diensten. Mehr dazu unter [Integration](/de/roadmap/integration/).
