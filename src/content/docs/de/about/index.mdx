...
| **v4.1+** | Datenformat-Add-ons — externe Toolkits (`gtfs-sqlite-toolkit`, `geojson-sqlite-toolkit`, `csv-tsv-sqlite-toolkit`) laden vollstaendige GeoJSON/CSV-Dateien per URL und fragen sie aus dem Speicher ab |
