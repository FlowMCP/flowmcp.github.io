...
Was die Levels bedeuten: [Agents und Architekturen →](/de/basics/agents/)
...
Warum Elicitation so wichtig ist: [Agents und Architekturen → Elicitation](/de/basics/agents/#elicitation-wenn-der-agent-rueckfragen-stellt)
...
Dokumentation: [CLI Nutzung](/de/docs/usage/cli/)
