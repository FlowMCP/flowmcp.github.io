...
Das uebernimmt [FlowMCP](/de/docs/getting-started/what-is-flowmcp/) — ein Open-Source-Framework, das Schemas laedt, die Struktur validiert, die Tests ausfuehrt und die Tools ueber das **Model Context Protocol (MCP)** bereitstellt. Ueber 100 KI-Clients unterstuetzen MCP bereits — von Claude ueber ChatGPT bis Cursor.
