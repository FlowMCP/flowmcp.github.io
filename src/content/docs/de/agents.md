...
- **Tool-Referenzen** — der Agent waehlt sich aus verschiedenen [Provider-Schemas](/de/schemas-and-tools/) die Tools aus, die er braucht. Er nimmt nicht alle, sondern nur die relevanten.
...
Welche Clients was unterstuetzen: [Clients und Kompatibilitaet →](/de/mcp-clients/)
...
- **Agent-Manifeste und Konfiguration:** [docs.flowmcp.org](https://docs.flowmcp.org)
