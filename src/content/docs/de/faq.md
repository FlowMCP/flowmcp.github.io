...
Konkrete Beispiele: [Use Cases →](/de/use-cases/)
...
Mehr dazu: [Schemas und Tools →](/de/schemas-and-tools/)
...
Welcher Client fuer wen: [Clients und Kompatibilitaet →](/de/mcp-clients/)
