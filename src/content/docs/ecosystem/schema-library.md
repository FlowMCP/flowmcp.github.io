...
2. **Create your schema**
   ...
   Write your schema following the [Schema Creation Guide](/guides/schema-creation). Place it in the appropriate provider directory.
...
- **FlowMCP Spec**: [Specification Overview](/specification/overview/)
