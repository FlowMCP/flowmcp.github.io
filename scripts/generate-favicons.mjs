// Favicon-Pipeline (PRD-08, REV-05 Kap. 8.2)
// Erzeugt favicon.ico (32), favicon-{16,32,48,192,512}.png,
// favicon.png (= 512), apple-touch-icon.png (180)
...
const generate = async () => {
    ...
    // favicon.png — 512 als Hauptdatei
